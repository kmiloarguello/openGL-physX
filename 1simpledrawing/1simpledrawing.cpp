...
void initPhysics()
{
    ...
    */
    ...
    PxRigidStatic* room1WallRight = PxCreatePlane(*gPhysics, PxPlane(0.0f, 0.0f, -1.0f, 100.0f),
                                                  *gMaterial);
    ...
    */
    PxRigidDynamic* ball = PxCreateDynamic(*gPhysics, PxTransform(PxVec3(0.0f, 50.0f, 0.0f)),
                                           PxSphereGeometry(10.0), *gMaterial, 1.0f);
    ...
    PxRigidDynamic* aConvexActor = gPhysics->createRigidDynamic(PxTransform(PxVec3(-10.0f, 50.0f,
                                   0.0f)));
