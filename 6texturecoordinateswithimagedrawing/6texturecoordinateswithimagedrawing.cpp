...
int main(int argc, char *argv[])
{
	...
	// Create window
	window = SDL_CreateWindow("TextureImageCoordinates-Drawing", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, window_width, window_height, SDL_WINDOW_OPENGL | SDL_WINDOW_RESIZABLE);
